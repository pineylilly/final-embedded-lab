    ...
    return (
        <nav className="bg-white px-2 sm:px-4 py-2.5 sticky w-full z-20 top-0 left-0 border-b border-gray-200">
            ...
            <div className="items-center justify-between flex w-auto order-1" id="navbar-sticky">
              <ul className="flex p-4 border border-gray-100 rounded-lg bg-gray-50 flex-row space-x-4 md:space-x-8 mt-0 text-sm font-medium">
                <li>
                  <a href="#" className="block text-sky-500 rounded" aria-current="page">Edit</a>
                </li>
              </ul>
            </div>
            </div>
